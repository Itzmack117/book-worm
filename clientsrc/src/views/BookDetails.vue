  ...
  <div class="BookDetails container">
    <div class="row">
      ...
      <div class="col-3 mt-4 mb-2">
        <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#orderModal">Order</button>
      </div>
    </div>
