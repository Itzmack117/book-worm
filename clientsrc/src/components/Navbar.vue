<template>
  <div>
    <nav
      class="navbar navbar-expand-lg navbar-light bg-gradient-primary"
      style="opacity: 1"
    >
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
          <li
            class=" nav-item otherFont text-white"
          ...
          <li
            class="pl-3 nav-item otherFont text-white"
          ...
          <li
            class="pl-3 nav-item otherFont text-white"
            :class="{ active: $route.name == 'invoice' }"
            v-if="$auth.isAuthenticated"
          >
        ...
        <span class="navbar-text">
          ...
          <button
            class="btn btn-danger otherFont border border-white"
            @click="logout"
            v-else
          >
            logout
    ...
    <div class="row bg-light otherFont" v-if="searchForm">
      <!-- v-if="searchForm" -->
      <div
        class="col-10 d-flex flex-column align-items-center mx-auto text-left py-2"
      >
      ...
      <div v-if="searchResults" class="row results bg-light otherFont">
        <div class="col-10 mx-auto mb-2">
          ...
          <div v-for="book in books" :key="book.id" :bookProp="book">
            ...
            >
              <div
                class="apiResults row border-bottom border-primary py-1 bg-info"
              >
                <div class="col-3 pt-2 text-left ">
                  <h6
                    class="resultOverflow"
                    data-toggle="tooltip"
                    data-placement="top"
                    :title="book.ISBN"
                  >
